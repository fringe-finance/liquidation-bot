...
export class ExchangeAggregatorService {
    ...
    async estimateBuyERC4626FromERC20(
        ...
        const erc4626Underlying = tokenOut.underlyingAssets[0];
    ...
    async estimateBuyERC20FromERC4626(
        ...
        const erc4626Underlying = tokenIn.underlyingAssets[0];
    ...
    async estimateBuyERC4626FromERC4626(
        ...
        const tokenInUnderlying = tokenIn.underlyingAssets[0];
        const estimation = await this.estimateBuyERC4626FromERC20(
    ...
    async estimateBuyERC4626FromLP(
        ...
        const tokenOutUnderlying = tokenOut.underlyingAssets[0];
